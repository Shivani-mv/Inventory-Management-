  ...
  <div class="graphs">
    ...
    <div class="xs tabls">
      <div class="bs-example4" data-example-id="contextual-table">
       <a href="add_emplyee.php"><button type="button" class="btn btn-primary">Add Branch</button></a><br><br>
        <table  class="display" width="100%" cellspacing="0">
          ...
          <tr>
            ...
            <td><a href="employee_details.php?deleteid=<?php echo $ros['id'];?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
          </tr>
          <?php
...
$sql="DELETE FROM `emplyee` WHERE `emplyee`.`id` = '$id'";
    ...
    if($res)
    {
      echo"<script>alert('Delete sucessfully');window.location='employee_details.php'</script>";
    }
    else
    {
      echo"<script>alert('data Delete error');window.location='employee_details.php'</script>";
