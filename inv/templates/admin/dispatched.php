    ...
    <div class="xs tabls">
      <div class="bs-example4" data-example-id="contextual-table">
        <table  class="display" width="100%" cellspacing="0">
          ...
          <tbody>
          <?php 
            $sql="Select * from consignment WHERE status='Dispatched'";
...
<!--            <td><a href="assign_to.php?id=<?php echo $ros['assign_to_id'];?>"><button type="button" class="btn btn-warning">Assign Delivery</button></a></td> -->
