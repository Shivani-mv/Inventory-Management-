...
<div id="page-wrapper">
  <div class="graphs">
    <h3 class="blank1">In-transit Courier reports</h3>
    ...
    <div class="xs tabls">
      <div class="bs-example4" data-example-id="contextual-table">
        <table   class="display" width="100%" cellspacing="0">
          ...
          <tbody>
          <?php 
            $sql="Select * from consignment WHERE status='In-transit' and branch_id='4005'";
          ...
          <tr>
            ...
            <td><a href="update_status_it.php?id=<?php echo $ros['ccn'];?>"><button type="button" class="btn btn-warning">Update Status</button></a></td>
