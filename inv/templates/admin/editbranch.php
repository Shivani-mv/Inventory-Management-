...
$sql=mysqli_query($conn,"select * from branch where branch_id='$id'");
...
<div id="page-wrapper">
			...
			<div class="tab-pane active" id="horizontal-form">
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="branch_name" placeholder="branch name" required=""  value="<?php echo $res['branch_name'];?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="pincode" required="" id="pincode" value="<?php echo $res['pincode'];?>"  >
							</div>
						</div>
							<div class="form-group">
	...
	if(isset($_REQUEST['applybranch']))
	{
		...
		$sql="UPDATE `branch` SET `branchaddress` = '$branchaddress', `phone` = '$phone' WHERE `branch`.`branch_id` = '$id'";
